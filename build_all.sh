...
docker build ${CACHECFG} --platform linux/riscv64 --tag ghcr.io/muhkuh-sys/mbs_ubuntu_2204_riscv64 --file dockerfile_mbs_ubuntu_2204_riscv64 .
docker build ${CACHECFG} --platform linux/arm64 --tag ghcr.io/muhkuh-sys/mbs_ubuntu_2204_arm64 --file dockerfile_mbs_ubuntu_2204_arm64 .
